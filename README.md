...
# Modify JWT_SECRET(random hex32), LLM API Keys, NEXTAUTH_SECRET, GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET in the .enc
# For JWT_SECRET, open terminal and use "openssl rand -hex 32" to generate random hex32 and copy paste in .env file.
